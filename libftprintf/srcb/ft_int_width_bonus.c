...
/*
 Handles printing integers with specific width formatting.
 Calls helper functions to handle padding and width based on flags,
 such as precision and minus.
 Writes the formatted integer to stdout, considering sign, padding,
 and precision.
*/
...
/*
 Processes the width formatting for integers, based on flags.
 Handles padding, precision, and width for the output based on flags like dot,
 zero, and minus.
*/
static int	ft_process_int_width(t_flags *flags, int to_print, int *n)
{
...
/*
 Handles the width formatting when precision is used.
 Decides whether to pad with spaces or zeros based
 on the width and precision flags.
*/
static int	ft_width_dot(t_flags *flags, int to_print, int *n)
{
	int	res;
...
/*
 Handles width and precision formatting when both are set.
 Ensures the correct padding of zeros or spaces based on flags like width,
 precision, and sign.
*/
static int	ft_width_prec_dot(t_flags *flags, int to_print, int *n)
{
